...
with sync_playwright() as playwright:
    ...
    description_empty_courses = page.get_by_test_id('courses-list-empty-view-description-text')
    expect(description_empty_courses).to_be_visible()
    expect(description_empty_courses).to_have_text('Results from the load test pipeline will be displayed here')
