...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_image_upload_image_title = page.get_by_test_id(
            'create-course-preview-image-upload-widget-info-title-text')
        self.preview_image_upload_image_description = page.get_by_test_id(
        ...
        self.preview_image_delete_image_button = page.get_by_test_id(
    ...
    def check_visible_image_upload_view(self, is_image_uploaded: bool = False):
        ...
        expect(self.preview_image_upload_image_title).to_be_visible()
        expect(self.preview_image_upload_image_title).to_have_text('Tap on "Upload image" button to select file')
        expect(self.preview_image_upload_image_description).to_be_visible()
        expect(self.preview_image_upload_image_description).to_have_text('Recommended file size 540X300')
        expect(self.preview_image_upload_image_button).to_be_visible()

        if is_image_uploaded:
            expect(self.preview_image_delete_image_button).to_be_visible()

    def click_remove_image_button(self):
        self.preview_image_delete_image_button.click()
